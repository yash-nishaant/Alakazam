...
if __name__ == "__main__":
    ...
    # $example on$
    lines = spark.read.text("s3://orderlogs-yashn/2020/07/22/11/*").rdd
    ...
    # Generate top 10 product recommendations for each product
    ...
    # Generate top 10 product recommendations for a specified set of products
    items = ratings.select(als.getItemCol()).distinct().limit(3)
